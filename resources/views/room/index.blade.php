...
@section('content')
    ...
    <div class="main">
        <h3>Available Rooms
            <a href="{{ url('admin/room/create') }}" class="add-rooms">Add Rooms</a>
        </h3>
        ...
        <table class="content-table">
            ...
            <tbody>
                @if ($data)
                    ...
                    <tr>
                        <td>{{$dt->id}}</td>
                        <td>{{$dt->roomtype->title}}</td>
                        <td>{{$dt->title}}</td>
                        <td>
                            <a href="{{url('admin/room/'.$dt->id)}}"><span class="material-symbols-outlined" id="view">visibility</span></a>
                            <a href="{{url('admin/room/'.$dt->id).'/edit'}}"><span class="material-symbols-outlined" id="edit">edit</span></a>
                            <a onclick="return confirm('(!) Are you sure you want to delete this room?')" href="{{url('admin/room/'.$dt->id).'/delete'}}" class="delete"><span class="material-symbols-outlined"
